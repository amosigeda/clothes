...
<style>
.add_order_table tr th, .add_order_table tr td {
    border-bottom: 1px solid #bbb;
    border-left: 1px solid #bbb;
    padding: 10px;
}
.add_order_table tr th {
    border-left: 0;
}
.add_order_table tr td:last-child {
    border-right: 1px solid #bbb;
}
/*	.add_order_table tr td:first-child{border-left: 0;}*/
/*	.add_order_table tr:last-child td{border-bottom:0;}*/
.add_order_table input, .add_order_table select {
    width: 100%;
    padding: 5px;
	...
	if(n <= 9) {
		for(var i = 0; i < 8; i++) {
			...
			if(i == 0) {
				...
				tab.rows[rownum].cells[i].innerHTML = '<input name="orderNumber' + n + '" type="text"   maxlength="100" />';
			} else if(i == 2) {
				tab.rows[rownum].cells[i].setAttribute("class", "td_bg_yellow");
				tab.rows[rownum].cells[i].innerHTML = '销售价格';
			} else if(i == 3) {
				tab.rows[rownum].cells[i].innerHTML = '<input name="xsjg' + n + '" type="text"   maxlength="100" />';
			}
		}
		...
		if(n<15){
			for (var i = 0; i < 8; i++) {
				...
				if (i == 0) {
					...
					tab.rows[rownum].cells[i].innerHTML = '<table class="tbl_11" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td class="td_bg_yellow" style="border-left: 0; border-bottom: 0; border-right: 1px solid #bbb;" nowrap="nowrap" align="center">米数</td><td style="border: 0;" nowrap="nowrap" align="center"><input name="ms'+n+'" type="text"   readonly="true" /></td></tr></tbody></table>';
				}else if(i == 5){
					tab.rows[rownum].cells[i].setAttribute("class", "padd0");
					tab.rows[rownum].cells[i].innerHTML = '<table class="tbl_11" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td class="td_bg_yellow" style="border-left: 0; border-bottom: 0; border-right: 1px solid #bbb;" nowrap="nowrap" align="center">价格</td><td style="border: 0;" nowrap="nowrap" align="center"><input name="jg' + n + '" type="text"  maxlength="100"   /></td></tr></tbody></table>';
				}else if(i == 6){
					tab.rows[rownum].cells[i].setAttribute("class", "td_bg_yellow");
...
-->
      ...
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
        <select name="qudao" value="qudao">
          <option value="" <%=projectInfo.getAt("qudao").equals("")? "selected":"" %>></option>
						<option value="深圳淘宝" <%=projectInfo.getAt("qudao").equals("深圳淘宝")? "selected":"" %>>深圳淘宝</option>
						<option value="南京淘宝" <%=projectInfo.getAt("qudao").equals("南京淘宝")? "selected":"" %>>南京淘宝</option>
        ...
        <%-- 	<input style="border:none;" name="qudao" type="radio" class="radio_1" value="淘宝" <%if("淘宝".equals("" + projectInfo.getAt("qudao"))){%>checked<%}%>>淘宝
						...
						<input style="border:none;" name="qudao" type="radio" class="radio_1" value="其他" <%if("其他".equals("" + projectInfo.getAt("qudao"))){%>checked<%}%>>其他 --%></td>
    ...
    <tr>
      ...
      <td  nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	    ...
	    <input style="border:none;" name="sex" type="radio" class="radio_1" value="女" <%if("女".equals("" + projectInfo.getAt("sex"))){%>checked<%}%>>女 --%></td>
    ...
    <tr>
      <td nowrap="nowrap" align="center" class="f_bold"> <%if("admin".equals(request.getAttribute("role"))|| "客服".equals(request.getAttribute("role"))|| "经理".equals(request.getAttribute("role"))|| "跟单".equals(request.getAttribute("role")) ){ %>
				<button type="button" onclick="addTableOrder();" style="margin-left: 0px;">+</button>
			 <%} %>订单号</td>
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
        <input style="border:none;" type="text"     name="orderNumber" id="orderNumber"  value=<%=request.getAttribute("orderNumberOne")%>>
        <%}else{ %>
        <input style="border:none;" type="text"  readonly="true"   name="orderNumber" id="orderNumber"  value=<%=request.getAttribute("orderNumberOne")%>>
        <%} %></td>
      <td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
        <input style="border:none;" type="text"     name="salePrice" id="salePrice"  value=<%=request.getAttribute("sale_price")%>>
        <%}else{ %>
        <input style="border:none;" type="text" readonly="true"    name="salePrice" id="salePrice"  value=<%=request.getAttribute("sale_price")%>>
        <%} %></td>
     ...
     <%if(!"".equals(orderall.getAt("orderNumber1"))&& orderall.getAt("orderNumber1")!=null ){ %>
          	<tr>
				...
				<input style="border:none;" type="text"     name="orderNumber1" id="orderNumber1"  value=<%=orderall.getAt("orderNumber1")%>>
				 <%}else{ %>
				<input style="border:none;" type="text"    readonly="true" name="orderNumber1" id="orderNumber1"  value=<%=orderall.getAt("orderNumber1")%>>
				    <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
				 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg1" id="xsjg1"  value=<%=orderall.getAt("xsjg1")%>>
	 <%}else{ %>
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
				<input style="border:none;" type="text"     name="orderNumber2" id="orderNumber2"  value=<%=orderall.getAt("orderNumber2")%>>
			<%}else{ %>
				<input style="border:none;" type="text"    readonly="true" name="orderNumber2" id="orderNumber2"  value=<%=orderall.getAt("orderNumber2")%>>
				 <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg2" id="xsjg2"  value=<%=orderall.getAt("xsjg2")%>>
			<%}else{ %>
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
				<input style="border:none;" type="text"     name="orderNumber3" id="orderNumber3"  value=<%=orderall.getAt("orderNumber3")%>>
			<%}else{ %>
				<input style="border:none;" type="text"   readonly="true"  name="orderNumber3" id="orderNumber3"  value=<%=orderall.getAt("orderNumber3")%>>
				 <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg3" id="xsjg3"  value=<%=orderall.getAt("xsjg3")%>>
			<%}else{ %>
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
				<input style="border:none;" type="text"     name="orderNumber4" id="orderNumber4"  value=<%=orderall.getAt("orderNumber4")%>>
			<%}else{ %>
				<input style="border:none;" type="text"  readonly="true"   name="orderNumber4" id="orderNumber4"  value=<%=orderall.getAt("orderNumber4")%>>
				 <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg4" id="xsjg4"  value=<%=orderall.getAt("xsjg4")%>>
			<%}else{ %>
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
				<input style="border:none;" type="text"     name="orderNumber5" id="orderNumber5"  value=<%=orderall.getAt("orderNumber5")%>>
			<%}else{ %>
				<input style="border:none;" type="text"  readonly="true"   name="orderNumber5" id="orderNumber5"  value=<%=orderall.getAt("orderNumber5")%>>
				 <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg5" id="xsjg5"  value=<%=orderall.getAt("xsjg5")%>>
			<%}else{ %>
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
				<input style="border:none;" type="text"     name="orderNumber6" id="orderNumber6"  value=<%=orderall.getAt("orderNumber6")%>>
			<%}else{ %>
				<input style="border:none;" type="text"  readonly="true"   name="orderNumber6" id="orderNumber6"  value=<%=orderall.getAt("orderNumber6")%>>
				 <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg6" id="xsjg6"  value=<%=orderall.getAt("xsjg6")%>>
			<%}else{ %>
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
				<input style="border:none;" type="text"     name="orderNumber7" id="orderNumber7"  value=<%=orderall.getAt("orderNumber7")%>>
			<%}else{ %>
				<input style="border:none;" type="text"  readonly="true"   name="orderNumber7" id="orderNumber7"  value=<%=orderall.getAt("orderNumber7")%>>
				 <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg7" id="xsjg7"  value=<%=orderall.getAt("xsjg7")%>>
			<%}else{ %>
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
				<input style="border:none;" type="text"     name="orderNumber8" id="orderNumber8"  value=<%=orderall.getAt("orderNumber8")%>>
			<%}else{ %>
				<input style="border:none;" type="text"   readonly="true"  name="orderNumber8" id="orderNumber8"  value=<%=orderall.getAt("orderNumber8")%>>
				 <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg8" id="xsjg8"  value=<%=orderall.getAt("xsjg8")%>>
			<%}else{ %>
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
				<input style="border:none;" type="text"     name="orderNumber9" id="orderNumber9"  value=<%=orderall.getAt("orderNumber9")%>>
			<%}else{ %>
				<input style="border:none;" type="text"  readonly="true"   name="orderNumber9" id="orderNumber9"  value=<%=orderall.getAt("orderNumber9")%>>
				 <%} %>
				</td>
				<td nowrap="nowrap" align="center" class="f_bold">销售价格</td>
				<td nowrap="nowrap" align="center" >
 ...
 <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
	<input style="border:none;" type="text"     name="xsjg9" id="xsjg9"  value=<%=orderall.getAt("xsjg9")%>>
			<%}else{ %>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"    readOnly="true"   name="project_no" id="project_no"   value="<%=projectInfo.getAt("add_time")%>"  ></td>
      <td nowrap="nowrap" align="center"  rowspan="2">客户地址</td>
      <td nowrap="nowrap" align="center"  colspan="3" rowspan="2"><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><%-- 		<input style="border:none;" name="orderType" type="radio" class="radio_1" value="新单" <%if("新单".equals("" + projectInfo.getAt("order_type"))){%>checked<%}%>>新单
      ...
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
        <input style="border:none;" type="text"        name="jiaofu_time" id="jiaofu_time"   value="<%=projectInfo.getAt("jiaofu_time")%>"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" >
        <%}else{ %>
    ...
    <tr class="t_subtitle">
      ...
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
        ...
        <%} %></td>
      <td nowrap="nowrap" align="center"  rowspan="4"><img src="http://47.111.148.8/watch/upload/test.png" width="100" height="100" /></td>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" class="f_bold">中腰</td>
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
        <input style="border:none;" type="text"        name="zhongyaoB" id="zhongyaoB"   value="<%=projectInfo.getAt("zhongyao_b")%>"  >
        <%}else{ %>
        <input style="border:none;" type="text"   readonly="true"     name="zhongyaoA" id="zhongyaoA"   value="<%=projectInfo.getAt("zhongyao_b")%>"  >
        <%} %></td>
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
        <input style="border:none;" name="zhongyaoB2"  type="text" class="txt_1" value="<%=projectInfo.getAt("zhongyao_b2")%>" >
        <font color="red"></font>
        <%}else{ %>
        <input style="border:none;" name="zhongyaoB2" readonly="true"  type="text" class="txt_1" value="<%=projectInfo.getAt("zhongyao_b2")%>" >
        <font color="red"></font>
        <%} %></td>
      <!--				<td nowrap="nowrap" align="center" ></td>--> 
    </tr>
    <tr class="td_bg_pink">
      ...
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
        ...
        <%} %></td>
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
        <input style="border:none;" name="fuweiB2"  type="text" class="txt_1" value="<%=projectInfo.getAt("fuwei_b2")%>">
        <font color="red"></font>
        <%}else{ %>
        <input style="border:none;" readonly="true"  name="fuweiB2"  type="text" class="txt_1" value="<%=projectInfo.getAt("fuwei_b2")%>">
        <font color="red"></font>
        <%} %></td>
      <!--				<td nowrap="nowrap" align="center" ></td>--> 
    </tr>
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><input style="border:none;" name="houzhongyichangA2"  type="text" class="txt_1" value="<%=projectInfo.getAt("houzhongyichang_a2")%>"></td>
      <td nowrap="nowrap" align="center"  rowspan="5"><input style="border:none;" name="dakuang1"  type="text" class="txt_1" value="<%=projectInfo.getAt("dakuang1")%>">
        <%-- 				 <textarea name="dakuang1" id="dakuang1" rows="8" cols="8" class="txt_1"  value="<%=projectInfo.getAt("dakuang1")%>"></textarea>
 --%></td>
      <%}else{ %>
      <td nowrap="nowrap" align="center" ><input style="border:none;" name="houzhongyichangA2" readonly="true"   type="text" class="txt_1" value="<%=projectInfo.getAt("houzhongyichang_a2")%>"></td>
      <td nowrap="nowrap" align="center"  rowspan="5"><input style="border:none;" name="dakuang1" readonly="true"  type="text" class="txt_1" value="<%=projectInfo.getAt("dakuang1")%>">
        <%-- 				 <textarea name="dakuang1" id="dakuang1" rows="8" cols="8" class="txt_1"  value="<%=projectInfo.getAt("dakuang1")%>"></textarea>
 --%></td>
      <%} %>
      ...
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
        ...
        <%} %></td>
      <%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" ><input style="border:none;" name="yichang_q"  type="text" class="txt_1" value="<%=projectInfo.getAt("yichang_q")%>"></td>
      <td nowrap="nowrap" align="center" rowspan="5"><input style="border:none;" name="dakuang2"  type="text" class="txt_1" value="<%=projectInfo.getAt("dakuang2")%>"></td>
      <%}else{ %>
      <td nowrap="nowrap" align="center" ><input style="border:none;" name="yichang_q" readonly="true"    type="text" class="txt_1" value="<%=projectInfo.getAt("yichang_q")%>"></td>
      <td nowrap="nowrap" align="center" rowspan="5"><input style="border:none;" name="dakuang2" readonly="true"  type="text" class="txt_1" value="<%=projectInfo.getAt("dakuang2")%>"></td>
      <%} %>
    </tr>
    <tr class="td_bg_pink">
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
        ...
        <%} %></td>
      <td nowrap="nowrap" align="center"  rowspan="4"><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
      ...
      <td nowrap="nowrap" align="center"  rowspan="4" colspan="2"><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
		...
		<input style="border:none;" name="kuanxingD" type="radio" class="radio_1" value="宽松+" <%if("宽松+".equals("" + projectInfo.getAt("kuanxing_d"))){%>checked<%}%>>宽松+ --%></td>
      <td nowrap="nowrap" align="center"  rowspan="4"><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><select name="kaicha" value="kaicha">
      ...
      <td nowrap="nowrap" align="center" ><select name="lingkoukuaishiB" value="lingkoukuaishiB">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">开叉</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("kaicha")%>>
      ...
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">领型</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("lingkoukuaishi_b")%>>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><select name="xiabai" value="xiabai">
      ...
      <td nowrap="nowrap" align="center" ><select name="zhuangse" value="zhuangse">
      ...
      <td nowrap="nowrap" align="center" ><select name="waizhubian" value="waizhubian">
      ...
      <td nowrap="nowrap" align="center" ><select name="xiucha" value="xiucha">
    ...
    <tr>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">下摆</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("xiabai")%>>
      ...
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">撞色</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("zhuangse")%>>
      ...
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">外珠边</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("waizhubian")%>>
        ...
        <%-- 	<input style="border:none;" name="waizhubian" 
					...
					color="red"></font> --%></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">袖叉</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("xiucha")%>>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><select name="kuyao" value="kuyao">
      ...
      <td nowrap="nowrap" align="center" ><select name="kuxing" value="kuxing">
	...
	<option value="阔腿裤" <%=projectInfo.getAt("kuxing").equals("阔腿裤")? "selected":"" %>  >阔腿裤</option>
      ...
      <td nowrap="nowrap" align="center" ><select name="chenshanling" value="chenshanling">
      ...
      <td nowrap="nowrap" align="center" ><select name="chenshanxiu" value="chenshanxiu">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">裤腰</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("kuyao")%>>
      ...
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">裤型</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("kuxing")%>>
      ...
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">衬衫领</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("chenshanling")%>>
      ...
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">衬衫袖</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("chenshanxiu")%>>
    ...
    <tr>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold"><%if("admin".equals(request.getAttribute("role"))|| "客服".equals(request.getAttribute("role"))|| "经理".equals(request.getAttribute("role"))|| "跟单".equals(request.getAttribute("role")) ){ %>
        <button type="button"  value="<%=request.getAttribute("gysall")%>"  onclick="addTable(this.value)"
			style="margin-left: 0px;">+</button>
        <%} %>
        面料</td>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"        name="miaoliao1" id="miaoliao1"   value="<%=projectInfo.getAt("miao_liao1")%>"  ></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yongtu1" value="yongtu1">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text"     readonly="true"   name="miaoliao1" id="miaoliao1"   value="<%=projectInfo.getAt("miao_liao1")%>"  ></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><input style="border:none;" type="text" readonly="true"     name="yongtu1" id="yongtu1"   value="<%=projectInfo.getAt("yong_tu1")%>"  ></td>
      <%} %>
      <td nowrap="nowrap" style="padding: 0;"><table class="tbl_11" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td nowrap="nowrap" align="center" style="border: 0;"><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
      ...
      <td nowrap="nowrap" style="padding: 0;"><table class="tbl_11" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td nowrap="nowrap" align="center" style="border: 0;"><%if("admin".equals(request.getAttribute("role")) || "跟单".equals(request.getAttribute("role")) ){ %>
              <input name="jg"  id="jg" type="text" class="txt_1" maxlength="100"  value=<%=duoyu.getAt("jq")%> >
              <%}else{ %>
              <input name="jg"  id="jg" type="text" class="txt_1" readonly="true"  maxlength="100" value=<%=duoyu.getAt("jq")%>  >
              <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
      <td nowrap="nowrap" align="center" ><%if("admin".equals(request.getAttribute("role")) || "跟单".equals(request.getAttribute("role")) ){ %>
    ...
    <tr>
      ...
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" ><input name="ml1" id="ml1"  value="<%=duoyu.getAt("ml1")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt1" value="yt1">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" ><input name="ml1" id="ml1"  value="<%=duoyu.getAt("ml1")%>" readonly="true"
		...
		<td nowrap="nowrap" style="padding: 0;"><table class="tbl_11" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td nowrap="nowrap" align="center" style="border: 0;"><%if("admin".equals(request.getAttribute("role")) || "跟单".equals(request.getAttribute("role")) ){ %>
              ...
              <%}else{ %>
              <input name="jg1"  id="jg1" type="text"  readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq1")%>  >
              <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" ><input name="ml2" id="ml2"  value="<%=duoyu.getAt("ml2")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt2" value="yt2">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" ><input name="ml2" id="ml2"  value="<%=duoyu.getAt("ml2")%>" readonly="true"
      ...
      <td nowrap="nowrap" style="padding: 0;"><table class="tbl_11" border="0" cellpadding="0" cellspacing="0">
        ...
        <%}else{ %>
        <input name="jg2"  id="jg2" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq2")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml3" id="ml3"  value="<%=duoyu.getAt("ml3")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt3" value="yt3">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml3" id="ml3"  value="<%=duoyu.getAt("ml3")%>" readonly="true"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg3"  id="jg3" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq3")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml4" id="ml4"  value="<%=duoyu.getAt("ml4")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt4" value="yt4">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml4" id="ml4"  value="<%=duoyu.getAt("ml4")%>" readonly="true"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg4"  id="jg4" type="text" readonly="true"  class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq4")%> >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml5" id="ml5"  value="<%=duoyu.getAt("ml5")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt5" value="yt5">
        ...
        <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml5" id="ml5"  value="<%=duoyu.getAt("ml5")%>" readonly="true"
      ...
      <%-- <input
        ...
        <%}else{ %>
        <input name="jg5"  id="jg5" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq5")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml6" id="ml6"  value="<%=duoyu.getAt("ml6")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt6" value="yt6">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml6" id="ml6"  value="<%=duoyu.getAt("ml6")%>"  readonly="true"
      ...
      <%} %>
		...
		<td nowrap="nowrap" style="padding: 0;"><table class="tbl_11" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold" style="border-left: 0; border-bottom: 0; border-right: 1px solid #bbb;">价格</td>
            <td nowrap="nowrap" align="center" style="border: 0;"><%if("admin".equals(request.getAttribute("role")) || "跟单".equals(request.getAttribute("role")) ){ %>
        <input name="jg6"  id="jg6" type="text" class="txt_1" maxlength="100"  value=<%=duoyu.getAt("jq6")%>>
        <%}else{ %>
        <input name="jg6"  id="jg6" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq6")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml7" id="ml7"  value="<%=duoyu.getAt("ml7")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt7" value="yt7">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml7" id="ml7"  value="<%=duoyu.getAt("ml7")%>" readonly="true"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg7"  id="jg7" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq7")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml8" id="ml8"  value="<%=duoyu.getAt("ml8")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt8" value="yt8">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml8" id="ml8"  value="<%=duoyu.getAt("ml8")%>" readonly="true"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg8"  id="jg8" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq8")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml9" id="ml9"  value="<%=duoyu.getAt("ml9")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt9" value="yt9">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml9" id="ml9"  value="<%=duoyu.getAt("ml9")%>" readonly="true"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg9"  id="jg9" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq9")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml10" id="ml10"  value="<%=duoyu.getAt("ml10")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt10" value="yt10">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml10" id="ml10"  value="<%=duoyu.getAt("ml10")%>" readonly="true"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg10"  id="jg10" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq10")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml11" id="ml11"  value="<%=duoyu.getAt("ml11")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt11" value="yt11">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml11" id="ml11"  value="<%=duoyu.getAt("ml11")%>" readonly="true"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg11"  id="jg11" type="text" readonly="true"  class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq11")%> >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml12" id="ml12"  value="<%=duoyu.getAt("ml12")%>"
				
				 type="text" 
					 placeholder=""
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt12" value="yt12">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml12" id="ml12"  value="<%=duoyu.getAt("ml12")%>" readonly="true"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg12"  id="jg12" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq12")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" >
        <input name="ml13" id="ml13"  value="<%=duoyu.getAt("ml13")%>"
				 ...
				 type="text" 
					 ...
					 /></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">用途</td>
      <td nowrap="nowrap" align="center" ><select name="yt13" value="yt13">
      ...
      <%}else{ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml13" id="ml13"  value="<%=duoyu.getAt("ml13")%>"
				 readonly="true"
				 type="text" 
					 placeholder=""
					 /></td>
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg13"  id="jg13" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq13")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      <%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">面料</td>
      <td nowrap="nowrap" align="center" ><input name="ml14" id="ml14"  value="<%=duoyu.getAt("ml14")%>"
      ...
      <%} %>
        ...
        <%}else{ %>
        <input name="jg14"  id="jg14" type="text" readonly="true" class="txt_1" maxlength="100" value=<%=duoyu.getAt("jq14")%>  >
        <%} %></td>
          </tr>
        </table></td>
      <td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">供应商</td>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="center" ><%if(!"".equals(projectInfo.getAt("fujian_url"))&& projectInfo.getAt("fujian_url")!=null ){ %>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="left"  colspan="7"><%if("admin".equals(request.getAttribute("role")) || "客服".equals(request.getAttribute("role")) || "经理".equals(request.getAttribute("role")) ){ %>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="left"  colspan="7"><%if("admin".equals(request.getAttribute("role")) || "批单".equals(request.getAttribute("role")) ){ %>
    ...
    <tr>
      ...
      <td nowrap="nowrap" align="left"  colspan="7"><%if("admin".equals(request.getAttribute("role")) || "跟单".equals(request.getAttribute("role")) ){ %>
    ...
    <tr>
      <td nowrap="nowrap" align="center" ><input style="border:none;" name="anniu"  id="anniu"
					 type="hidden" class="txt_1"  />
					 	 <input  name="addhang"  id="addhang" type="hidden" class="txt_1"    value="<%=orderall.getAt("addhang")%>" >
							<input  name="addhang1"  id="addhang1" type="hidden" class="txt_1"   value="<%=orderall.getAt("addhang1")%>">
					 </td>
      <td nowrap="nowrap" align="right" ><input style="border:none;" type="button" title ="1"  name="ok" accesskey="y" tabindex="y"  value="保存" class="but_1 btn" onclick="onUpdate(this.title)">
        <input style="border:none;" type="button" title ="2"  name="ok" accesskey="y" tabindex="y"  value="保存并提交" class="but_1 btn" onclick="onUpdate(this.title)"  style="font-size:12;width:80px;height:21px;"></td>
      <td nowrap="nowrap" align="left"  colspan="6"><input style="border:none;" type="button" name="back" accesskey="b" tabindex="b" value="返 回" class="but_1 btn" onclick="location='doProjectInfo.do?method=queryProjectInfoXml'">
