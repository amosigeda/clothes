...
-->
	...
	<input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("order_id")%>>
				...
				<td nowrap="nowrap" align="center" >
				<input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("qudao")%>>
				...
				<td nowrap="nowrap" align="center" ><input style="border:none;" type="text"     name="wechat" id="wechat"  value=<%=projectInfo.getAt("wechat")%>></td>
				<td nowrap="nowrap" align="center" class="f_bold">下单客服</td>
				<td><input style="border:none;" type="text"      name="project_no" id="project_no"   value="<%=projectInfo.getAt("xiadan_kefu")%>"  ></td>
...
<input style="border:none;" type="text"     name="projectNo" id="projectNo"  value=<%=projectInfo.getAt("ww_name")%>>
	    ...
	    <input style="border:none;" name="orderType" type="radio" class="radio_1" value="重做" <%if("重做".equals("" + projectInfo.getAt("order_type"))){%>checked<%}%>>重做 --%>
	    	<input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("order_type")%>>
	    	<!-- <select name="orderType" value="orderType">
				...
				<td nowrap="nowrap" align="center" >
					<input style="border:none;" type="text"        name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("jiaofu_time")%>"  >
...
<!--				<td nowrap="nowrap" align="center" ></td>-->
			...
			<input style="border:none;" type="text"        name="fuweiA" id="fuweiA"   value="<%=projectInfo.getAt("fuwei_a")%>"  >
				...
				<td nowrap="nowrap" align="center" >
				 <input style="border:none;" name="fuweiA2"  type="text" class="txt_1" value="<%=projectInfo.getAt("fuwei_a2")%>">
				</td>
...
<%-- 				 <textarea name="dakuang1" id="dakuang1" rows="8" cols="8" class="txt_1"  value="<%=projectInfo.getAt("dakuang1")%>"></textarea>
 --%>				</td>
				...
				<td nowrap="nowrap" align="center" >
				<input style="border:none;" name="yichangB2"  type="text" class="txt_1" value="<%=projectInfo.getAt("yichang_q")%>">
				</td>
				<td nowrap="nowrap" align="center" rowspan="5">
		...
		<input style="border:none;" type="text"        name="qianyichangA" id="qianyichangA"   value="<%=projectInfo.getAt("qianyichang_a")%>"  >
			...
			<!-- 	<td nowrap="nowrap" align="center" ></td> -->
				<td nowrap="nowrap" align="center" class="f_bold">腹围</td>
				<td nowrap="nowrap" align="center" >
				 <input style="border:none;" name="fuwei_quea"  type="text" class="txt_1" value="<%=request.getAttribute("fuwei_quea")%>">
				</td>
				<td nowrap="nowrap" align="center" >
				 <input style="border:none;" name="fuwei_quea"  type="text" class="txt_1" value="<%=request.getAttribute("fuwei_queb")%>">
				</td>
<!--				<td nowrap="nowrap" align="center" ></td>-->
			</tr>
			<tr>
	...
	<input style="border:none;" type="text"        name="xiuchangB" id="xiuchangB"   value="<%=projectInfo.getAt("xiuchang_b")%>"  >
				...
				<td nowrap="nowrap" align="center" >
					<input style="border:none;" type="text"        name="xiuchangB" id="xiuchangB"   value="<%=projectInfo.getAt("xc_que")%>"  >
				</td>
				<!-- <td nowrap="nowrap" align="center" ></td> -->
				<td nowrap="nowrap" align="center" class="f_bold">袖长</td>
				<td nowrap="nowrap" align="center" >
...
<!--				<td nowrap="nowrap" align="center" ></td>-->
			...
			<tr>
				...
				<td nowrap="nowrap" align="center" >	<input style="border:none;" type="text"        name="yaoweiC" id="yaoweiC"   value="<%=projectInfo.getAt("yaowei_c")%>"  ></td>
				<td nowrap="nowrap" align="center" >
			...
			<tr class="td_bg_pink">
				...
				<td nowrap="nowrap" align="center" >	<input style="border:none;" type="text"        name="tuiweiC" id="tuiweiC"   value="<%=projectInfo.getAt("tuiwei_c")%>"  ></td>
				<td nowrap="nowrap" align="center" >
...
<!--				<td nowrap="nowrap" align="center" ></td>-->
	...
	<input style="border:none;" type="text"        name="dangweiC" id="dangweiC"   value="<%=projectInfo.getAt("dangwei_c")%>"  >
				...
				<td nowrap="nowrap" align="center" class="f_bold">中腰</td>
				<td nowrap="nowrap" align="center" >	<input style="border:none;" type="text"        name="zhongyaoD" id="zhongyaoD"   value="<%=projectInfo.getAt("zhongyao_d")%>"  ></td>
				<td nowrap="nowrap" align="center" >
...
<!--				<td nowrap="nowrap" align="center" ></td>-->
			...
			<tr class="td_bg_pink">
				...
				<td nowrap="nowrap" align="center" >	<input style="border:none;" type="text"        name="datuiC" id="datuiC"   value="<%=projectInfo.getAt("datui_c")%>"  ></td>
				<td nowrap="nowrap" align="center" >
				<input style="border:none;" name="datuiC2"  type="text" class="txt_1" value="<%=projectInfo.getAt("datui_c2")%>">
				</td>
				
				<td nowrap="nowrap" align="center" class="f_bold">衣长</td>
				<td nowrap="nowrap" align="center" >	<input style="border:none;" type="text"        name="yichangD" id="yichangD"   value="<%=projectInfo.getAt("yichang_d")%>"  ></td>
				<td nowrap="nowrap" align="center" >
...
<!--				<td nowrap="nowrap" align="center" ></td>-->
			...
			<tr>
				...
				<td nowrap="nowrap" align="center" >	<input style="border:none;" type="text"        name="zhongtuiC" id="zhongtuiC"   value="<%=projectInfo.getAt("zhongtui_c")%>"  ></td>
				<td nowrap="nowrap" align="center" >
				...
				<td nowrap="nowrap" align="center" >
					<input style="border:none;" name="dakuang3"  type="text" class="txt_1" value="<%=projectInfo.getAt("kuanxing_d")%>">
...
<!--				<td nowrap="nowrap" align="center" ></td>-->
			...
			<input style="border:none;" type="text"        name="miaoliao1" id="miaoliao1"   value="<%=projectInfo.getAt("miao_liao1")%>"  >
				...
				<td nowrap="nowrap" align="center" >
					 <input style="border:none;" type="text"     name="yongtu1" id="yongtu1"   value="<%=projectInfo.getAt("yong_tu1")%>"  >
		...
		<%-- 	<tr>
				...
				<td nowrap="nowrap" align="center" >
				<input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("yong_tu2")%>>
				...
				<td nowrap="nowrap" align="center" >
				<input style="border:none;" type="text"   readOnly="true"    name="project_no1" id="project_no1" value=<%=projectInfo.getAt("gongyingshang_2")%>>
	...
	<input style="border:none;" type="text"     name="remark" id="remark"   value="<%=projectInfo.getAt("remark")%>"  >
</td>
			</tr>
			<tr>
				<td nowrap="nowrap" align="center" class="td_bg_yellow f_bold">批单备注</td>
				<td nowrap="nowrap" align="left"  colspan="7">
				<input style="border:none;" type="text"    name="pidanremark" id="pidanremark"   value="<%=projectInfo.getAt("pidan_remark")%>" >
			...
			<tr>
				...
				<td nowrap="nowrap" align="left"  colspan="7">
					<input style="border:none;" type="text"      name="gdremark" id="gdremark"   value="<%=projectInfo.getAt("gd_remark")%>"  > 
				</td>
			</tr>
