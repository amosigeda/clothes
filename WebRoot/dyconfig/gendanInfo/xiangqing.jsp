...
<table width="100%" class="tbl_11" border="1" bordercolorlight=#000000
			...
			<tr>
				<th colspan="8" nowrap="nowrap" align="left">订单详情信息</th>
			</tr>
	    ...
	    <input name="sex" type="radio" class="radio_1" value="女" <%if("女".equals("" + projectInfo.getAt("sex"))){%>checked<%}%>>女 --%>
	      ...
	      <input type="text"    readOnly="true"   size="20"  name="sex" id="sex"   value="<%=projectInfo.getAt("sex")%>"  >
			...
			<tr>
				<td>西装数量</td>
				<td>	
				<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("xizhuang_number")%>"  >
				</td>
				<td>衣码</td>
				<td>	<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("yi_ma")%>"  ></td>
				<td>衬衫数量</td>
				<td>	<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("chenshan_number")%>"  ></td>
				<td>衬衫码</td>
				<td>
				<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("chenshan_ma")%>"  >
				</td>
			...
			<tr>
				...
				<td>
				 <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA2" id="jiankuanA2"   value="<%=projectInfo.getAt("jiankuan_a2")%>"  >
				</td>
				<td>领围</td>
				<td>
				...
				<td>
				  <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="lingweiB2" id="lingweiB2"   value="<%=projectInfo.getAt("lingwei_b2")%>"  >
			</td>	
				<td>
				</td>
				<td></td>
			...
			<tr>
				...
				<td>
				  <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="xiongweiA2" id="xiongweiA2"   value="<%=projectInfo.getAt("xiongwei_a2")%>"  >
				</td>
				<td>胸围</td>
				<td>
				...
				<td>
				  <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="xiongweiB2" id="xiongweiB2"   value="<%=projectInfo.getAt("xiongwei_2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
				   <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="zhongyaoA2" id="zhongyaoA2"   value="<%=projectInfo.getAt("zhongyao_a2")%>"  >
				</td>
				<td>中腰</td>
				<td>
				...
				<td>
				  <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="zhongyaoB2" id="zhongyaoB2"   value="<%=projectInfo.getAt("zhongyao_b2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
				   <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="fuweiA2" id="fuweiA2"   value="<%=projectInfo.getAt("fuwei_a2")%>"  >
				</td>
				<td>腹围</td>
				<td>
				...
				<td>
				   <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="fuweiB2" id="fuweiB2"   value="<%=projectInfo.getAt("fuwei_b2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
				    <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="houzhongyichangA2" id="houzhongyichangA2"   value="<%=projectInfo.getAt("houzhongyichang_a2")%>"  >
				</td>
				<td>袖长</td>
				<td>
				...
				<td>
					     <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="xiuchangB2" id="xiuchangB2"   value="<%=projectInfo.getAt("xiuchang_b2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				<td>前衣长</td>
				<td>
						<input type="text"    readOnly="true"     size="20"  name="qianyichangA" id="qianyichangA"   value="<%=projectInfo.getAt("qianyichang_a")%>"  >
				</td>
				<td>
				 	     <input type="text"    readOnly="true"    size="20"  name="qianyichangA2" id="qianyichangA2"   value="<%=projectInfo.getAt("qianyichang_a2")%>"  >
				</td>
				<td>袖肥</td>
				<td>
						<input type="text"    readOnly="true"      size="20"  name="xiufeiB" id="xiufeiB"   value="<%=projectInfo.getAt("xiufei_b")%>"  >
					</td>
				<td>
	 <input type="text"    readOnly="true"   readOnly="true"   size="20"  name="xiufeiB2" id="xiufeiB2"   value="<%=projectInfo.getAt("xiufei_b2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
		<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="xiuchangA2" id="xiuchangA2"   value="<%=projectInfo.getAt("xiuchang_a2")%>"  >
				</td>
				<td>袖口</td>
				<td>
				...
				<td>
			<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="xiukouB2" id="xiukouB2"   value="<%=projectInfo.getAt("xiukou_b2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="xiukouB2" id="xiukouB2"   value="<%=projectInfo.getAt("xiufei_a2")%>"  >
				</td>
				<td>领口款式</td>
				<td>
				...
				<td>
						<input type="text"    readOnly="true"     size="20"  name="xiukouB2" id="xiukouB2"   value="<%=projectInfo.getAt("lingkoukuaishi_b2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
						<input type="text"    readOnly="true"     size="20"  name="xiukouB2" id="xiukouB2"   value="<%=projectInfo.getAt("xiukou_a2")%>"  >
				</td>
				<td>衣长</td>
				<td>
				...
				<td>
						<input type="text"    readOnly="true"     size="20"  name="xiukouB2" id="xiukouB2"   value="<%=projectInfo.getAt("yichang_b2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				<td>西裤数量</td>
				<td>	<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("xiku_number")%>"  ></td>
				<td>裤码</td>
				<td><input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("ku_ma")%>"  ></td>
				<td>马甲数量</td>
				<td>	<input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("majia_number")%>"  ></td>
				<td>马甲码</td>
					<td><input type="text"    readOnly="true"   readOnly="true"   size="20"  name="jiankuanA" id="jiankuanA"   value="<%=projectInfo.getAt("majia_ma")%>"  ></td>
			...
			<tr>
				...
				<td>
					<input type="text"    readOnly="true"     size="20"  name="kuchang_c2" id="kuchang_c2"   value="<%=projectInfo.getAt("kuchang_c2")%>"  >
				</td>
				<td>胸围</td>
				<td>
				...
				<td>
				<input type="text"    readOnly="true"     size="20"  name="kuchang_c2" id="kuchang_c2"   value="<%=projectInfo.getAt("xiongwei_d2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
						<input type="text"    readOnly="true"     size="20"  name="kuchang_c2" id="kuchang_c2"   value="<%=projectInfo.getAt("yaowei_c22")%>"  >
				</td>
				<td>中腰</td>
				<td>
				...
				<td>
					<input type="text"    readOnly="true"     size="20"  name="zhongyaoD" id="zhongyaoD"   value="<%=projectInfo.getAt("yaowei_c2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
				<input type="text"    readOnly="true"     size="20"  name="zhongyaoD" id="zhongyaoD"   value="<%=projectInfo.getAt("tuiwei_c2")%>"  >
				</td>
				<td>衣长</td>
				<td>
				...
				<td>
					<input type="text"    readOnly="true"     size="20"  name="zhongyaoD" id="zhongyaoD"   value="<%=projectInfo.getAt("yichang_d2")%>"  >
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<input type="text"    readOnly="true"     size="20"  name="zhongyaoD" id="zhongyaoD"   value="<%=projectInfo.getAt("dangwei_c2")%>"  >
				</td>
				<td></td>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<td>
					<input type="text"    readOnly="true"     size="20"  name="dangweiC" id="dangweiC"   value="<%=projectInfo.getAt("datui_c2")%>"  >
				</td>
				<td></td>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<td>
						<input type="text"    readOnly="true"     size="20"  name="dangweiC" id="dangweiC"   value="<%=projectInfo.getAt("zhongtui_c2")%>"  >
				</td>
				<td></td>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<td>
					<input type="text"    readOnly="true"     size="20"  name="dangweiC" id="dangweiC"   value="<%=projectInfo.getAt("xiaotui_c2")%>"  >
				</td>
				<td></td>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<td>
						<input type="text"    readOnly="true"     size="20"  name="dangweiC" id="dangweiC"   value="<%=projectInfo.getAt("tuikou_c2")%>"  >
				</td>
				<td></td>
				<td></td>
				<td></td>
