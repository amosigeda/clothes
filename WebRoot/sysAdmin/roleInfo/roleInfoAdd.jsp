...
<body>
	...
	<form name="frm" method="post"
		action="doRoleInfo.do?method=insertRoleInfo" onsubmit="return onAdd()">
		<input name="roleType" type="hidden" value="角色">
		<table width="100%" class="tbl_11">
			<tr>
				<th colspan="13" nowrap="nowrap" align="left">添加角色</th>
			</tr>
			<tr class="tr_11">
			...
			<tr class="tr_11">
				<td></td>
				<td colspan="2"><input type="button" name="ok" accesskey="y"
					tabindex="y" value="确 定" class="but_1" onclick="onAdd()">

					<input type="button" name="back" accesskey="b" tabindex="b"
					value="返 回" class="but_1"
					onclick="location='doRoleInfo.do?method=queryRoleInfo'"></td>
			</tr>
		</table>
	</form>
</body>
