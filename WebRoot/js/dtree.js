...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url) {
		str += '<tr class="" id="s' + this.obj + nodeId + '">\n<td nowrap="nowrap">\n<a  id="p' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" href="' + node.url + '"';
